<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/Employer_MasterPage.master" AutoEventWireup="true" CodeFile="JobSeekerFullDetail.aspx.cs" Inherits="Employer_JobSeekerFullDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="contact" id="contact">
        <div class="container">
            <h5 style="text-align: center;">JOBSEEKER FULL DETAIL</h5>
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER PROFILE</h5><br />
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER PERSONAL</h5><br />
            <div class="col-md-12 table-responsive">
                <div class="col-md-12 table-responsive">
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER EDUCATIONAL</h5><br />
            <div class="col-md-12 table-responsive">
                <div class="col-md-12 table-responsive">
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER EXPERIENCE</h5><br />
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER SKILL</h5><br />
    ...
    <div style="background: rgb(245, 245, 245); width: 100%;">
        <div class="container">
            <h5 style="text-align: left;">JOBSEEKER HOBBY</h5><br />
